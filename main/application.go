...
func HelpInfo() {
	fmt.Println("- To put a key-value pair: 					 [Put key value] e.g. Put ThisIsKeyText ThisIsValueText")
	fmt.Println("- To get the respective value of a given key: [Get key]       e.g. Get Rouge Info")
